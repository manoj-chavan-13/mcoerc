...
// --- MOCK ASSETS ---
// Replace with actual HOD image for Computer Engineering
const HodImage =
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
      <div className="p-6 rounded-2xl border border-slate-200 flex items-center gap-4 hover:shadow-md transition-shadow">
        ...
        <div>
          ...
          <p className="text-2xl font-serif font-bold text-slate-900">2001</p>
        </div>
      </div>
      <div className="p-6 rounded-2xl border border-slate-200 flex items-center gap-4 hover:shadow-md transition-shadow">
    ...
    <div className="flex flex-col md:flex-row gap-10 items-start">
      <div className="flex-1 space-y-6">
        ...
        <p className="text-slate-600 leading-loose text-lg">
          The Computer Engineering Department is the cornerstone of technical
          innovation at Matoshri College of Engineering. Since its inception,
          the department has been at the forefront of producing high-caliber
          engineers who drive the global software and hardware industry.
        </p>
        <p className="text-slate-600 leading-loose text-lg">
          With the largest intake of{" "}
          <span className="font-bold text-slate-800">180 students</span>, we
          offer a robust curriculum integrating{" "}
          <span className="font-bold text-slate-800">
            Machine Learning, Big Data Analytics, Cyber Security
          </span>
          , and Full Stack Development. Our aim is to foster creativity and
          problem-solving skills through hands-on exposure to cutting-edge
          technologies.
        </p>
      </div>
      ...
      <div className="w-full md:w-72 shrink-0">
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-lg shadow-blue-900/5 text-center relative group overflow-hidden">
          ...
          <p className="text-sm text-slate-500 italic mb-4">
            "Empowering minds to engineer the digital future."
          </p>
  ...
  <div className="grid gap-8 animate-in fade-in duration-500">
    <div className="bg-gradient-to-br from-blue-950 to-blue-900 text-white p-10 rounded-2xl shadow-xl relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="text-xl text-blue-100 leading-relaxed font-light">
          "To achieve excellence in Computer Engineering education by creating
          competent professionals with strong ethical values for the betterment
          of society."
        </p>
      </div>
    </div>
    ...
    <div className="bg-white border border-slate-200 p-10 rounded-2xl shadow-sm relative">
      ...
      <div className="space-y-6">
        {[
          "To provide a strong theoretical and practical foundation in Computer Engineering.",
          "To promote research, innovation, and entrepreneurship among students.",
          "To inculcate professional ethics, leadership qualities, and social responsibilities.",
        ].map((m, i) => (
        ...
        return (
          <>
            <SectionHeader
              ...
              subtitle="Latest updates from Computer Engineering"
            />
            <InfoCards
              icon={Newspaper}
              items={[
                {
                  ...
                  desc: "Hosted a 3-day international workshop on Big Data and Hadoop with industry experts.",
                  date: "Dec 05, 2024",
                },
                {
                  title: "CODE-FEST 2K24",
                  desc: "Annual coding competition 'Code-Fest' saw participation from over 500 students across the state.",
                  date: "Oct 15, 2024",
                },
              ]}
            />
        ...
        return (
          <>
            <SectionHeader
              ...
              subtitle="Meet our experienced academic team"
            />
            <PersonGrid
              people={[
                {
                ...
                {
                  name: "Prof. N. L. Bhirud",
                  role: "Associate Professor",
                  qual: "M.E. (CSE), Ph.D (Pursuing)",
                  exp: "18 Years",
                },
                {
                  name: "Prof. V. R. Ghule",
          ...
          <>
            ...
            <DocumentTable
              ...
              rows={[
                {
                  p: "2019 Pattern",
                  c: "SE Computer Engineering",
                  s: "Sem I & II",
                },
                {
                  p: "2019 Pattern",
                  c: "TE Computer Engineering",
                  s: "Sem I & II",
                },
                {
                  p: "2019 Pattern",
                  c: "BE Computer Engineering",
                  s: "Sem I & II",
                },
              ]}
            />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                >
                  ...
                  <img
                    src={`https://source.unsplash.com/random/800x600?code,server,${i}`}
                    alt={lab}
                  ...
                  <div className="absolute bottom-0 left-0 p-8 z-20 translate-y-2 group-hover:translate-y-0 transition-transform">
                    ...
                    <p className="text-blue-200 text-sm flex items-center gap-2">
                      <Server size={14} /> 30+ i7 Workstations
                    </p>
                  </div>
                </div>
              ))}
        ...
        return (
          <>
            ...
            <DocumentTable
              ...
              rows={[
                { n: "Aditya Roy", c: "NVIDIA", p: "18.0 LPA" },
                { n: "Sneha Patil", c: "TCS Digital", p: "7.5 LPA" },
                { n: "Rohan Mehta", c: "Accenture", p: "6.5 LPA" },
              ]}
            />
          </>
        );
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-8">
            <div className="max-w-3xl">
              ...
              <div className="flex items-center gap-2 text-blue-300/80 text-xs font-bold tracking-widest uppercase mb-6">
                ...
                <span className="text-amber-400">Computer Engineering</span>
              </div>
              ...
              <p className="text-blue-100/80 text-lg md:text-xl max-w-2xl font-light leading-relaxed border-l-4 border-amber-500 pl-6">
                Driving the digital revolution through excellence in coding,
...
export default AcademicsCompEng;
